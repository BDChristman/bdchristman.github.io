...
On this page you will find the books and papers that I have read for enjoyment and general edification outside of work and school. 
...
p <- ggplot(New_Data, aes(Days, Pages_Total)) + geom_line(size=1.25, color = "#E6E6FA") + geom_point() + xlab("Days") + ylab("Total Pages Read") + theme_classic() + theme(legend.position = "none") + transition_reveal(Days)
